...
var Cli = (function () {
    ...
    Cli._execute = function (command, args, convertSuccessCallback, convertFailedCallback) {
        ...
        childProcess.stdout.on("data", function (data) {
            ...
            if(data.toString().indexOf("dconverter success") >= 0){
                if(typeof(convertSuccessCallback) === 'function'){
                    convertSuccessCallback(pageCount);
                }
            }
            if(data.toString().indexOf("dconverter failed") >= 0){
            ...
            if(findDataIndex != -1){
                ...
                }else if(pageCount.contains('\r')){
                    pageCount = pageCount.substring(0, pageCount.indexOf('\r')-1);
                }
            }
